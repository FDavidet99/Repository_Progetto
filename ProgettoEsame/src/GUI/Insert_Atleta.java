...
//	}
	...
	public Insert_Atleta(Controller c) throws SQLException {
		...
		JButton ReturnMen�Button = new JButton("Men\u00F9");
		ReturnMen�Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Controller.GotoHomePageFromInsertAtleta();
			}
		});
		ReturnMen�Button.setBounds(300, 258, 89, 23);
		contentPane.add(ReturnMen�Button);

		...
		Insert_Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ProcuratoreSportivo TempProcuratore = new ProcuratoreSportivo (NomeTextField.getText(), CognomeTextField.getText(), (Sesso)SessoComboBox.getSelectedItem(),
							TempDate , TempNazione,TempProvincia,TempComune);
					controller.InsertProcuratoreInDB(TempProcuratore);
